...
class TabsWidgetTest {
    ...
    void constructorWithTitles() {
        TabsWidget w = new TabsWidget(List.of("Tab1", "Tab2"));
        assertNotNull(w);
    }
    ...
    void defaultSelected() {
        TabsWidget w = new TabsWidget(List.of("A", "B", "C"));
    ...
    void selectInvalid() {
        TabsWidget w = new TabsWidget(List.of("A", "B"));
        w.select(5);
        assertEquals(0, w.selected());
        w.select(-1);
        assertEquals(0, w.selected());
    ...
    void renderSelectedStyle() {
        ...
        TabsWidget w = new TabsWidget(List.of("A", "B"), sel, norm);
        w.select(1);
        Buffer b = new Buffer(20, 3);
        w.render(new Rect(0, 0, 20, 3), b);
    ...
    void renderClipsAtWidth() {
        TabsWidget w = new TabsWidget(List.of("Tab1", "Tab2", "Tab3"));
    ...
    void renderCustomStyles() {
        ...
        TabsWidget w = new TabsWidget(List.of("Tab"), sel, norm);
