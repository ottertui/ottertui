...
class LanternaBackendTest {

    @Test
    @DisplayName("LanternaBackend can be instantiated")
    @DisabledIfEnvironmentVariable(named = "CI", matches = "true")
    void instantiateWhenTerminalAvailable() {
        try {
            LanternaBackend backend = new LanternaBackend();
    ...
    void classImplementsTerminalBackend() {
        assertTrue(TerminalBackend.class.isAssignableFrom(LanternaBackend.class));
    }
